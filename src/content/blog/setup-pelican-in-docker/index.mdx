...
import dockerfileChanges1 from "./dockerfile-changes1.png";
import dockerfileChanges2 from "./dockerfile-changes2.png";
...
Pelican is the successor to [Pterodactyl](https://pterodactyl.io/) and is intended to improve on aspects of game server management where Pterodactyl fell short. Pelican is currently in Beta and this guide is currently up-to-date with Panel [v1.0.0-beta18](https://github.com/pelican-dev/panel/releases/tag/v1.0.0-beta18) and Wings [v1.0.0-beta10](https://github.com/pelican-dev/wings/releases/tag/v1.0.0-beta10).
...
<Banner type={BannerType.Success}>
  Looking to _update_ your Pelican Panel and Wings installation to the latest
  version? See my guide [here](./update-pelican-in-docker)!
</Banner>
...
<Banner type={BannerType.Info}>
  Note that you can alternatively pass these args into the `docker build`
  command. I am choosing to add them here since we are already editing the
  Dockerfile. Example: `docker build --build-arg TARGETOS=linux --build-arg
  TARGETARCH=amd64 -t pelican-dev/panel:latest .`
</Banner>
...
<Image
  src={dockerfileChanges1}
  alt="Dockerfile arg declarations and uncommented lines"
/>
...
<Image src={dockerfileChanges2} alt="Dockerfile suggested text replacement" />
