...
Pelican is the successor to [Pterodactyl](https://pterodactyl.io/) and is intended to improve on aspects of game server management where Pterodactyl fell short. Pelican is currently in Beta and this guide is currently up-to-date with Panel [v1.0.0-beta22](https://github.com/pelican-dev/panel/releases/tag/v1.0.0-beta22) and Wings [v1.0.0-beta14](https://github.com/pelican-dev/wings/releases/tag/v1.0.0-beta14).
...
cd ~/wings
git switch release/v1.0.0-beta14
```
