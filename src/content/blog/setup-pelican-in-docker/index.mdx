...
Pelican is the successor to [Pterodactyl](https://pterodactyl.io/) and is intended to improve on aspects of game server management where Pterodactyl fell short. Pelican is currently in Beta and this guide is currently up-to-date with Panel [v1.0.0-beta16](https://github.com/pelican-dev/panel/releases/tag/v1.0.0-beta16) and Wings [v1.0.0-beta9](https://github.com/pelican-dev/wings/releases/tag/v1.0.0-beta9).

<Banner type={BannerType.Info}>
  Note that Pelican Panel
  [v1.0.0-beta17](https://github.com/pelican-dev/panel/releases/tag/v1.0.0-beta17)
  is the latest version at this time, but there is a bug that causes the web
  interface to time out after a few minutes. It seems the issue will be
  addressed in PR [#894](https://github.com/pelican-dev/panel/pull/894). I
  recommend using Panel v1.0.0-beta16 at this time.
</Banner>
...
Optionally switch Git branches to the latest release to ensure stable features.

````bash
cd ~/panel
git switch release/v1.0.0-beta16

cd ~/wings
git switch release/v1.0.0-beta9
---
