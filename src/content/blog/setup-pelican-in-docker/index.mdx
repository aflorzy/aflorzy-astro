...
Pelican is the successor to [Pterodactyl](https://pterodactyl.io/) and is intended to improve on aspects of game server management where Pterodactyl fell short. Pelican is currently in Beta and this guide is currently up-to-date with Panel [v1.0.0-beta21](https://github.com/pelican-dev/panel/releases/tag/v1.0.0-beta21) and Wings [v1.0.0-beta13](https://github.com/pelican-dev/wings/releases/tag/v1.0.0-beta13).
...
```bash
cd ~/panel
git switch release/v1.0.0-beta21

cd ~/wings
git switch release/v1.0.0-beta13
```
