...
import npmPanelProxyHost from "./npm-panel-proxy-host.png";
import npmPanelProxyHost2 from "./npm-panel-proxy-host2.png";
import npmStreamDropdown from "./npm-stream-dropdown.png";
import npmStream from "./npm-stream.png";
import npmWingsProxyHost from "./npm-wings0-proxy-host.png";
import npmWingsProxyHost2 from "./npm-wings0-proxy-host2.png";
import minecraftConfig1 from "./pterodactyl-mc-server1.png";
import minecraftConfig2 from "./pterodactyl-mc-server2.png";
import minecraftConfig3 from "./pterodactyl-mc-server3.png";
import minecraftConfig4 from "./pterodactyl-mc-server4.png";
import pterodactylNodeCreation from "./pterodactyl-node-creation.png";
import pterodactylNodeAllocations from "./pterodactyl-wings0-allocations.png";
...
```yaml title="/home/aflorzy/pterodactyl/docker-compose.yml" collapse={4-16, 19-23, 26-56, 59-82, 88-93}
services:
  db:
...
<section class="img-row">
  <Image src={npmPanelProxyHost} alt="NPM panel proxy host configuration" />
  <Image
    src={npmPanelProxyHost2}
    alt="NPM panel proxy host configuration SSL tab"
  />
</section>
...
<Image
  src={pterodactylNodeCreation}
  quality="max"
  alt="Pterodactyl Node creation screen with details filled in"
/>
...
<section class="img-row">
  <Image src={npmWingsProxyHost} alt="NPM Wings proxy host entry Details tab" />
  <Image src={npmWingsProxyHost2} alt="NPM Wings proxy host entry SSL tab" />
</section>
...
<Image
  src={pterodactylNodeAllocations}
  alt="Allocating ports 25560-25570 for Node Wings0"
/>
...
<Image src={minecraftConfig1} alt="Minecraft server name and node selection" />
...
<Image
  src={minecraftConfig2}
  alt="Minecraft server application feature limits configuration"
/>

<Image
  src={minecraftConfig3}
  alt="Minecraft server memory and disk space configuration"
/>
...
<Image
  src={minecraftConfig4}
  alt="Minecraft Server egg and startup command configuration"
/>
...
Interested in a new and refreshed way to create game servers? Check out my guide on [how to set up Pelican Panel in Docker](setup-pelican-in-docker) next!
