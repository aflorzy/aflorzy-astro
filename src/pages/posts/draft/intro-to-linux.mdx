...
Now that you're sold on Linux and have an instance up and running, I'm going to run through some of the fundamental concepts and commands that you should know when using Linux.
