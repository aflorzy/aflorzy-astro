...
Conceptually, you can think of containers as very lightweight virtual machines. It's like having a tiny linux operating system running inside of *your* computer. Each container is typically designed to serve one specific purpose and that is to run a single program as a service. If you want multiple services, you can either spin up multiple containers, or even build your own docker container 'image' with the exact software configuration you need.
